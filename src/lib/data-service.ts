...
import { Project, SubTask, Category, Invoice, InternalTaskNote, Shift, BreakType, InventoryItem, Part, User, Technician, Media } from './types';
import { fullRestorationTemplate, majorServiceTemplate } from './project-templates';

// --- STORAGE KEYS ---
const PROJECTS_STORAGE_KEY = 'AAM_PROJECTS';
const SHIFTS_STORAGE_KEY = 'AAM_TIMESHEETS';
const INVENTORY_STORAGE_KEY = 'AAM_INVENTORY';
const TEMPLATES_STORAGE_KEY = 'AAM_TEMPLATES';
const USERS_STORAGE_KEY = 'AAM_USERS';
const TECHNICIANS_STORAGE_KEY = 'AAM_TECHNICIANS';
