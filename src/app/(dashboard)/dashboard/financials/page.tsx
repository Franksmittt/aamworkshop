...
// --- CORRECTED: Removed unused 'Project' import ---
...
export default function FinancialsPage() {
    ...
    return (
        <div>
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-white">Money Dashboard</h1>
                <p className="text-gray-400">Profitability and cost analysis for all projects.</p>
            </div>
