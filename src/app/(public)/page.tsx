...
export default function Home() {
  ...
  const handleLogin = (role: UserRole) => {
    login(role); // Set the role in our global context
    ...
    switch (role) {
      case 'Boss':
        ...
        break;
      case 'Manager':
        router.push('/dashboard'); // Manager and Boss share the main view for now
        break;
      case 'Technician':
        router.push('/dashboard/my-tasks'); // A new dedicated page for technicians
        break;
      case 'Client':
      ...
      <div className="relative z-20 w-full max-w-2xl mx-auto">
        ...
        >
            ...
            <div className="backdrop-blur-sm bg-gray-900/50 p-8 rounded-lg border border-white/10 shadow-large">
                <h2 className="text-center text-2xl font-bold text-white mb-6">Select Your Role to Login</h2>
                <div className="space-y-4 mb-8">
                     <Input 
                        type="text" 
                        placeholder="Username / Email / Project Code"
                        value={username}
